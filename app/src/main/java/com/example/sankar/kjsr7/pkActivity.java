...
Button b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pk);final String regno = SharedPrefManager.getInstance(this).getregno();
        b = findViewById(R.id.button3pk);
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RegRequestpk regRequest = new RegRequestpk(regno,responseListener);
                //RequestQueue queue = Volley.newRequestQueue(EventActivity.this);
                //queue.add(regRequest);
                RequestHandler.getInstance(pkActivity.this).addToRequestQueue(regRequest);
